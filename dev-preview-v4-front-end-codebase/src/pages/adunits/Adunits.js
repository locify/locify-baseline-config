        ...
        <>
            <Grid container className={classes.container} spacing={4}>
                <Grid item lg={12} className={classes.headingContainer}>
                    <Typography variant="h1" weight="bold" className={classes.advKey}>Advertiser | Key Analystics</Typography>
                    <Typography className={classes.acBalance}>0.00 DAI ACCOUNT BALANCE</Typography>
                </Grid>
            </Grid>
                        ...
                        >
                            ...
                            {stableSort(rows, getComparator(order, orderBy))
                                ...
                                return (
                                    ...
                                    <TableCell align="left"><CalendarMonthIcon color="primary" className={classes.calIcon}/>{row.date}</TableCell>
                                    <TableCell align="left" className={classes.lastTd}>
                                        <RemoveRedEyeIcon color="primary" className={classes.customIcon}/>
                                        <ContentCopyIcon color="primary" className={classes.customIcon}/>
                                        ...
                                        <div className={classes.customIcon}>
                                            ...
                                            <StyledMenu
                                                ...
                                                onClose={handleClose}
                                                >
                                                <MenuItem onClick={handleClose} disableRipple className={classes.editItem}>
                                                    <EditIcon className={classes.editIconColor}/>
                                                    <span className={classes.editLable}>Edit</span>
                                                </MenuItem>
                                                <MenuItem onClick={handleClose} disableRipple className={classes.deleteItem}>
            ...
            >
                    ...
                    <React.Fragment>
                      ...
                      <div className={classes.customInputField}>
                        <FormControl fullWidth>
                          <InputLabel id="demo-simple-select-label">Avertising Type</InputLabel>
                          <Select
                            labelId="demo-simple-select-label"
                            id="demo-simple-select"
                            value={age}
                            label="AAvertising Type"
                      ...
                      <div className={classes.customInputField}>
                        <FormControl fullWidth>
                          <InputLabel id="demo-simple-select-label">Programatic direct</InputLabel>
                          <Select
                            labelId="demo-simple-select-label"
                            id="demo-simple-select"
                            value={age}
                      ...
                      {activeStep == 1 && 
                        <form id="form-file-upload" className={classes.formFileUpload} onDragEnter={handleDrag} onSubmit={(e) => e.preventDefault()}>
                          <input ref={inputRef} type="file" id="input-file-upload" className={classes.inputFileUpload} multiple={true} onChange={filehandleChange} />
                          <label id="label-file-upload" htmlFor="input-file-upload" className={dragActive ? classes.dragActiveStyle : classes.labelFileUpload }>
                            <div>
                              <p>Drag and drop your file here or</p>
                              <button className={classes.uploadButton} onClick={onButtonClick}>Upload a file</button>
                            </div> 
                          </label>
                ...
                <Button onClick={handleBack} disabled={activeStep === 0} variant="outlined" className={classes.roundedButton}>Back</Button>
                <Button onClick={handleNext} variant="contained" className={classes.roundedButton}>{activeStep === steps.length - 1 ? 'Save' : 'Continue'}</Button>
                </DialogActions>
            </Dialog>
        </>
    )
